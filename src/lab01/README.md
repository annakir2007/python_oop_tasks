...
1. Реализовать валидацию как отдельный метод
    ...
    * вынесена в отдельные методы (`_validate_gpa`, `_validate_name`, …) в отдельнои файле `lab01/validate.py`
...
* Наличие отчета в README.md-файле в репозитории.

---

# Про содержимое отчета

Расписываете по пунктам весь мыслительный процесс, который привел Вас к созданию конкретного класса.
Ответы на 5 вопросов с Практического занятия №1. Затем скриншоты работы файлика `demo.py` с описанием сценариев.
